...
export function ProductPage() {
  ...
  if (error) {
    return (
      <div>
        <Link to={catalogPage.path} className="text-blue-600 hover:underline mb-4 inline-block">
          ← Back to catalog
        </Link>
  ...
  return (
    <div>
      <Link to={catalogPage.path} className="text-blue-600 hover:underline mb-6 inline-block">
        ← Back to catalog
      </Link>
